...
const MathCalculatorsPage = () => {
  ...
  const mathCalculators = calculatorsData.calculators.filter((calc: any) => calc.category === 'math');
  
  const filteredCalculators = mathCalculators.filter((calc: any) =>
  ...
  return (
    <>
      <Helmet>
        <title>Math Calculators - CalcVerse</title>
        <meta name="description" content="Free math calculators including scientific, algebra, geometry, statistics, and more. Calculate instantly with our online tools." />
        <meta name="keywords" content="math calculator, scientific calculator, algebra calculator, geometry calculator, statistics calculator" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-100">
        ...
        <header className="bg-white shadow-sm border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <p className="text-gray-600">Math Calculators</p>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8">
                {mathCalculators.length} calculators for scientific, algebra, geometry, and statistics calculations
              </p>
              ...
              <div className="max-w-md mx-auto relative">
                ...
                <Input
                  type="text"
                  placeholder="Search math calculators..."
                  value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCalculators.map((calculator: any) => (
          ...
          <div className="mt-12 bg-white rounded-lg shadow-sm p-8 text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <div className="text-3xl font-bold text-purple-600">{mathCalculators.length}</div>
                <div className="text-gray-600">Math Calculators</div>
              </div>
              <div>
