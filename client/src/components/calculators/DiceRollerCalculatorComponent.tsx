...
const DiceRollerCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-teal-100 to-teal-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Generate random dice rolls for tabletop games, probability experiments, statistical simulations, and educational activities with customizable dice configurations.
        </p>
      </div>
