...
const DueDateCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate pregnancy due dates, fetal development timelines, and milestone tracking based on conception date or last menstrual period with medical accuracy.
        </p>
      </div>
