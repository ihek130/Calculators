...
const VolumeCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate volume of geometric shapes, containers, and irregular objects for capacity planning, shipping, and mathematical applications.
        </p>
      </div>
