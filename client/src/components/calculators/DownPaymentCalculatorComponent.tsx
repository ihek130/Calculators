...
const DownPaymentCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate down payment amounts, percentages, and requirements for home purchases, auto loans, and major purchases. Plan savings goals and loan qualifications.
        </p>
      </div>
