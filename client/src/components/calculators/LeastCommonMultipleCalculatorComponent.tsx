...
const LeastCommonMultipleCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Least Common Multiple Calculator</h1>
        <p className="text-lg text-gray-600">
          Find the least common multiple of numbers for fraction operations, scheduling problems, and mathematical applications with step-by-step solutions.
        </p>
      </div>
