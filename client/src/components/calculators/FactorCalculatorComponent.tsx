...
const FactorCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Factor Calculator</h1>
        <p className="text-lg text-gray-600">
          Find all factors, prime factors, and factor pairs of numbers for mathematical analysis, cryptography applications, and number theory problems.
        </p>
      </div>
