...
const MeanMedianModeRangeCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Mean Median Mode Range Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate comprehensive statistical measures including mean, median, mode, range, and standard deviation for data analysis and research.
        </p>
      </div>
