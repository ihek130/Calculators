...
const PrimeFactorizationCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Find prime factors and factor trees of numbers for mathematical analysis, cryptography applications, and number theory problems.
        </p>
      </div>
