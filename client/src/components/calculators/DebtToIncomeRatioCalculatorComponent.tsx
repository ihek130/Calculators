  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-green-100 to-green-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Debt To Income Ratio Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate debt-to-income ratio to assess financial health, loan qualification eligibility, and mortgage approval chances. Essential for financial planning and lending.
        </p>
      </div>
