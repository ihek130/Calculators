    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate area of geometric shapes including rectangles, circles, triangles, trapezoids, and complex polygons. Essential for construction, landscaping, flooring, and educational geometry problems.
        </p>
      </div>
...
export default AreaCalculatorComponent;