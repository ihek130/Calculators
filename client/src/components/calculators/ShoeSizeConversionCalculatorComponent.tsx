...
const ShoeSizeConversionCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Shoe Size Conversion Calculator</h1>
        <p className="text-lg text-gray-600">
          Convert shoe sizes between US, UK, EU, and international sizing systems for accurate footwear purchases and size matching.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-gray-800">
            About Shoe Size Conversion Calculator
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-gray-500 text-center py-8">
