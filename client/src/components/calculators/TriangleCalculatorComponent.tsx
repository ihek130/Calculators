...
const TriangleCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate triangle properties including area, perimeter, angles, and side lengths using various formulas for geometry and construction.
        </p>
      </div>
...
export default TriangleCalculatorComponent;