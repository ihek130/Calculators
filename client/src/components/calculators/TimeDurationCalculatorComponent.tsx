...
const TimeDurationCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate time duration between dates and times, project timelines, and elapsed time for planning and scheduling applications.
        </p>
      </div>
...
export default TimeDurationCalculatorComponent;