...
const OneRepMaxCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">One Rep Max Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate one-repetition maximum (1RM) for weightlifting exercises to plan strength training programs and track progression safely.
        </p>
      </div>
