...
const BusinessLoanCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate business loan payments, interest rates, and repayment schedules for commercial financing. Compare lenders and determine affordable financing for your business.
        </p>
      </div>
