...
const ConceptionCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Conception Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate fertility windows, ovulation dates, and optimal conception timing for family planning. Track menstrual cycles and maximize chances of pregnancy.
        </p>
      </div>
