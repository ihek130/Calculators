...
const CommonFactorCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Common Factor Calculator</h1>
        <p className="text-lg text-gray-600">
          Find the greatest common factor (GCF) and least common multiple of multiple numbers. Essential for fraction simplification, mathematical problem solving, and number theory.
        </p>
      </div>
