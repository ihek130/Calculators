...
const MulchCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate mulch quantities needed for landscaping projects with coverage area calculations, depth requirements, and material cost estimates.
        </p>
      </div>
