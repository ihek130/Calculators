...
const RentalPropertyCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Rental Property Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate rental property cash flow, cap rates, ROI, and investment metrics for real estate investment analysis and property management.
        </p>
      </div>
