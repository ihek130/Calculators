    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Use this pace calculator to estimate running, walking, or biking speed, pace, time, and distance. Perfect for training, race planning, or fitness tracking in any distance unit.
        </p>
      </div>
...
export default PaceCalculatorComponent;