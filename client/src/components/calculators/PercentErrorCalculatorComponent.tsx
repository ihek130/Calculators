...
const PercentErrorCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Percent Error Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate percentage error between expected and actual values for scientific experiments, statistical analysis, and quality control measurements.
        </p>
      </div>
...
export default PercentErrorCalculatorComponent;