  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">BAC Calculator</h1>
        <p className="text-lg text-gray-600">
          Use this BAC calculator to estimate Blood Alcohol Content based on drinks consumed, body weight, gender, and time elapsed. Important for responsible drinking and safety awareness.
        </p>
      </div>
