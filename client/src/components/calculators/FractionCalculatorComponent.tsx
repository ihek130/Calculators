...
const FractionCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Perform fraction calculations including addition, subtraction, multiplication, division, simplification, and mixed number conversions with step-by-step solutions.
        </p>
      </div>
