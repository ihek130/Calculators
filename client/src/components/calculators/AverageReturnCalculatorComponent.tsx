...
const AverageReturnCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        <Calculator className="mx-auto mb-4 h-12 w-12 text-gray-700" />
        <h1 className="text-3xl font-bold mb-2">Average Return Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate investment average returns and analyze portfolio performance over time. Essential for investors tracking ROI, comparing investments, and making informed financial decisions.
        </p>
      </div>
