...
const ExponentCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Exponent Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate exponential expressions, power functions, and scientific notation for mathematical, engineering, and scientific applications with high precision.
        </p>
      </div>
...
export default ExponentCalculatorComponent;