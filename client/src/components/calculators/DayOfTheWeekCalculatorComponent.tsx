...
const DayOfTheWeekCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Day Of The Week Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate what day of the week any date falls on, including historical dates and future projections. Perfect for planning events and historical research.
        </p>
      </div>
