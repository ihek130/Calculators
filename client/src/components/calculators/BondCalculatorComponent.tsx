  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Bond Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate bond yields, prices, current yield, and returns for fixed-income investments. Essential for bond investors, portfolio planning, and retirement income strategies.
        </p>
      </div>
