...
const TargetHeartRateCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate target heart rate zones for cardiovascular exercise, fitness training, and optimal workout intensity based on age and fitness level.
        </p>
      </div>
