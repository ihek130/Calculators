...
const MatrixCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Perform matrix operations including addition, multiplication, determinants, inverse calculations, and linear algebra for mathematical and engineering applications.
        </p>
      </div>
