...
const StairCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate stair dimensions including rise, run, total rise, and building code compliance for construction and home improvement projects.
        </p>
      </div>
