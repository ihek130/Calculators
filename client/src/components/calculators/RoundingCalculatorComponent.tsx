...
const RoundingCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-purple-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Rounding Calculator</h1>
        <p className="text-lg text-gray-600">
          Round numbers to specified decimal places, significant figures, or nearest whole numbers for mathematical precision and formatting.
        </p>
      </div>
...
export default RoundingCalculatorComponent;