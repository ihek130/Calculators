...
const ScientificNotationCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Scientific Notation Calculator</h1>
        <p className="text-lg text-gray-600">
          Convert numbers to and from scientific notation for mathematical, scientific, and engineering applications with proper formatting.
        </p>
      </div>
