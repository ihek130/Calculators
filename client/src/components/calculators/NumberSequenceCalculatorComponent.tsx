...
const NumberSequenceCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-teal-100 to-teal-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Number Sequence Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate and analyze arithmetic, geometric, and Fibonacci number sequences with pattern recognition and formula generation.
        </p>
      </div>
