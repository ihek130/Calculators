...
const GreatestCommonFactorCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        <Calculator className="mx-auto mb-4 h-12 w-12 text-gray-700" />
        <h1 className="text-3xl font-bold mb-2">Greatest Common Factor Calculator</h1>
        <p className="text-lg text-gray-600">
          Find the greatest common factor and least common multiple of multiple numbers for fraction operations, mathematical problem solving, and number theory.
        </p>
      </div>
