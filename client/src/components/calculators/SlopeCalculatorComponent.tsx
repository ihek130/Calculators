...
const SlopeCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Slope Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate slope, gradient, rise over run, and linear relationships between points for mathematical analysis and graphing applications.
        </p>
      </div>
...
export default SlopeCalculatorComponent;