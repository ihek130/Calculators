...
const IdealWeightCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-orange-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate ideal weight ranges using multiple medical formulas including BMI, body frame analysis, and health guidelines for optimal wellness.
        </p>
      </div>
...
export default IdealWeightCalculatorComponent;