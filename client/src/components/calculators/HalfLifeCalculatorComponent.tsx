...
const HalfLifeCalculatorComponent = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Half Life Calculator</h1>
        <p className="text-lg text-gray-600">
          Calculate radioactive decay rates, half-life periods, and remaining quantities for nuclear physics, medical applications, and scientific research.
        </p>
      </div>
