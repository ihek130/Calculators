    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate British Thermal Units for heating and cooling system sizing. Essential for HVAC planning, energy efficiency calculations, and home comfort optimization.
        </p>
      </div>
