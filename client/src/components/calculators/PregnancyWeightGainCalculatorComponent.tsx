...
const PregnancyWeightGainCalculatorComponent = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-green-100 to-green-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate healthy pregnancy weight gain recommendations based on pre-pregnancy BMI, trimester progress, and medical guidelines.
        </p>
      </div>
