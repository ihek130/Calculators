    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate differences between dates, add or subtract days, weeks, months, or years. Perfect for project planning, age calculations, and timeline management.
        </p>
      </div>
