    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-teal-100 to-teal-200 p-8 rounded-xl mb-8 text-gray-800 text-center">
        ...
        <p className="text-lg text-gray-600">
          Calculate daily calorie needs based on age, gender, weight, height, activity level, and fitness goals. Perfect for weight management, diet planning, and nutrition tracking.
        </p>
      </div>
